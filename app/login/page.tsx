  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#0A192F]">
      <div className="w-full max-w-md p-8 space-y-6 bg-[#111827] rounded-lg shadow-md">
        <h1 className="text-2xl font-bold text-center text-[#40A9FF]">Login</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full px-4 py-2 text-lg font-semibold text-[#40A9FF] border-2 border-[#40A9FF] rounded-md transition duration-300 ${
              isLoading
